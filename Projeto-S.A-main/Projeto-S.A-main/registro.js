...
let validNome = false;  // Variável que indica se o campo nome é válido ou não
...
let validSobrenome = false;  // Variável que indica se o campo sobrenome é válido ou não

const email = document.getElementById('email');  // Campo de input para o email
const spanEmail = document.getElementById('spanEmail');  // Elemento para mostrar o status da validação do email
let validEmail = false;  // Variável que indica se o campo email é válido ou não
...
let validSenha = false;  // Variável que indica se o campo senha é válido ou não
...
let validConfirmaSenha = false;  // Variável que indica se o campo confirmaSenha é válido ou não
...
function cadastrar() {
    ...
    if (validEmail && validSenha && validSobrenome && validNome && validConfirmaSenha) {
        ...
        alert('Algo está errado. Verifique os campos.');
    }
}
